            ...
            describe("ctoken receiver refund", ()=>{
                ...
                describe("failure", ()=>{
                    ...
                    it("fails to refund an non opened order", async()=>{
                        await thtlc.refundOrder(2, {from: ctokenReceiver}).should.be.rejectedWith(REVERTS.NOT_OPENED)
                    })
    
                    it("fails to refund a non funded order", async()=>{
                        
                        await thtlc.refundOrder(1, {from: ctokenReceiver}).should.be.rejectedWith(REVERTS.NOT_FUNDED)
